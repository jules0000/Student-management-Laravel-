    ...
    <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-zinc-900">
        ...
        <div class="relative z-10 flex flex-col justify-between p-12 w-full">
            <div class="flex items-center gap-3">
                ...
                <span class="text-xl font-bold tracking-tight text-white">Student Portal</span>
            </div>

            <div class="max-w-md">
                <h2 class="text-4xl font-bold text-white leading-tight mb-6">
                    View your details and grades.
                </h2>
            ...
            <div class="flex items-center gap-4 text-zinc-400 text-sm">
                <span>© {{ date('Y') }} Student Portal</span>
            </div>
        </div>
    </div>
    ...
    <div class="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 lg:p-24">
        <div class="w-full max-w-md">
            <div class="lg:hidden flex flex-col items-center mb-12">
                ...
                <h1 class="text-3xl font-bold tracking-tight text-zinc-900">Student Portal</h1>
            </div>

            <div class="mb-8">
                <h2 class="text-3xl font-bold text-zinc-900 mb-2">Welcome back</h2>
                <p class="text-zinc-600">Please sign in to view your grades.</p>
            </div>
            ...
            <form method="POST" action="{{ route('student.login.attempt') }}" class="space-y-6">
                @csrf
                <div class="space-y-2">
